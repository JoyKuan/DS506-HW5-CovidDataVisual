...
rawdata_state = pd.read_csv('latimes-state-totals.csv')
...
p_state.add_layout(Title(text="Data providing: local public health agencies.", text_font_style="italic"), 'above')
...
rawdata_race = pd.read_csv('cdph-race-ethnicity.csv')
...
p_cases.add_layout(Title(text="Data providing: California Department of Public Health", text_font_style="italic"), 'above')
...
p_death.add_layout(Title(text="Data providing: California Department of Public Health", text_font_style="italic"), 'above')
